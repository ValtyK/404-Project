...
int main(int argc, char **argv) {
    ...
    // Tentative d'accords a partir d'un tableau de frequences
    double freqs[] = {261.63, 329.63, 392.00}; // Do, Mi, Sol
    generate_chord(7, 9, freqs, 3, 3000.0, sample_rate);
    
    generate_envelope(0, 9, 30.0, 20.0, 80.0, 30.0, sample_rate);
